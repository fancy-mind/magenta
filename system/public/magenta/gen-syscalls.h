...
extern uint32_t mx_system_get_num_cpus(void) __attribute__((__leaf__)) __attribute__((const));

extern uint32_t _mx_system_get_num_cpus(void) __attribute__((__leaf__)) __attribute__((const));
...
extern mx_status_t mx_pci_map_mmio(
    mx_handle_t handle,
    uint32_t bar_num,
    mx_cache_policy_t cache_policy,
    mx_handle_t out_handle[1]) __attribute__((__leaf__));

extern mx_status_t _mx_pci_map_mmio(
    mx_handle_t handle,
    uint32_t bar_num,
    mx_cache_policy_t cache_policy,
    mx_handle_t out_handle[1]) __attribute__((__leaf__));
...
extern mx_status_t mx_pci_map_config(
    mx_handle_t handle,
    mx_handle_t out_handle[1]) __attribute__((__leaf__));

extern mx_status_t _mx_pci_map_config(
    mx_handle_t handle,
    mx_handle_t out_handle[1]) __attribute__((__leaf__));
